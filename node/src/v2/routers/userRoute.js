...
const { validateUserSchema, registerUser, validateOtpSchema, userOtp, validateUserLogin, userLogin, validateForgetPassword, forgetPassword, validateChangePassword, changePassword, uploadProfile, validateUploadProfile, upload } = require('../controller/userController.js');
